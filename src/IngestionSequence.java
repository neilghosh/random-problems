...
public class IngestionSequence {
...
class Graph {
    public String[] files = {"A", "B", "C", "D", "E", "F"};
    ...
    // topological sorts
    public void allTopologicalSortsUtil(boolean[] visited,
        ...
        if (!flag) {
            stack.forEach(i -> System.out.print(files[i] + " "));
            System.out.println();
        }
